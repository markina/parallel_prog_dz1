...
Практическое задание по курсу Параллельное Программирование 2014 год.
...
* src/main/java/ru/ifmo/pp/fgb/Bank.java содержится интерфейся для гипотетического
  банка с набором операций getNumberOfAccounts, getAmount, getTotalAmount, deposit, withdraw, transfer.

* src/main/java/ru/ifmo/pp/fgb/BankImpl.java содержится реализация операция банка для
...
* src/test/java/ru/ifmo/pp/fgb/MTStressTest.java проверяет основные аспекты корректности работы банка при
  множестве одновременно работающих потоков исполнения.

* src/test/java/ru/ifmo/pp/fgb/LinearizabilityTest.java проверяет все аспекты корректности работы банка и
...
Для сдачи выполненного задания присылайте мне письмо по электронной почте ответом на письмо с заданием.
 ...
 Subject: Re: Задание FineGrainedBank 2014
